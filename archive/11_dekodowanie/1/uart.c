...
void Reciever_GetStringCopy(char * ucDestination)
{
	...
	for(ucCharCounter = 0; sRecieverBuffer.cData[sRecieverBuffer.ucCharCtr] != NULL; ucCharCounter++)
  {
		ucDestination[ucCharCounter] = sRecieverBuffer.cData[sRecieverBuffer.ucCharCtr];
	}
	ucDestination[ucCharCounter] = NULL;
	sRecieverBuffer.ucCharCtr=0;
